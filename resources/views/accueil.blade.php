...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <!-- Menu -->
        <div id="NavBarContainer" style="text-align:right; margin-right:4%;">
            <p style="color:#E7E8F2;">
                <span class="selected" style="color:#ef3b2d;">Acceuil</span> 
                &nbsp; 
                <span>C.V.</span> 
                &nbsp; 
                <span>Projets</span> 
        ...
        <!-- Trait séparateur -->
        <div style="height:1px; width:100%; background-color:#E7E8F2; opacity:0.2;"></div>
