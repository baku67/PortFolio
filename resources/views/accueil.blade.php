            ...
            <div id="citationAndLightBulbWrapper">
                ...
                <div class="lightBulbWrapperDiv">
                    ...
                    <!-- <svg class="lightBulbContainer5">
                        <path 
                            id="lightBulbPath5"
                            d="M 159 795 L 159 794 M 143 703 L 159 794 Q 147 746 173 748 Q 198 748 186 697 L 197 785 C 199 809 209 734 241 735 C 282 731 286 780 244 783 C 208 782 208 734 247 734 Q 288 722 294 749 Q 317 804 320 745 C 324 728 360 754 387 743 Q 410 726 383 718 Q 353 712 344 750 Q 336 787 415 771 C 425 769 430 740 435 718 C 445 724 456 728 473 732 Q 452 784 484 777"
                        />
                    </svg> -->
                </div>
