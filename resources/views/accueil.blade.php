    ...
    <body id="body">
        ...
        <header>
            <div style="width:100%;">
                ...
                <h2 id="portfolioSousTitre" style="margin-left:6%; color:#ef3b2d; font-size:1.2em;">Basile KUNTZ <span style="color:#E7E8F2; font-size:80%;"> -  Développeur Web <span id="lineBreakMobileStatus"></br></span><span id="status"> En formation</span><span id="status2"> En recherche d'alternance CDA</span></span></h2>
            </div>
