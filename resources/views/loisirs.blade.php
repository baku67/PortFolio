...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div id="pageContainer">
            ...
            <h4 id="photographieTitle"><span id="photoTitlePart1">Ph<img src="img/letterO_red2.png" class="letterO"/>t<img src="img/letterO_red2.png" class="letterO"/></span><span id="photoTitlePart2">graph<span id="letterIandPoint">i<span id="letterIpoint" class="letterIpointAnim">.</span><span id="photoBar"></span><span id="flashRectangle"></span></span>e</span></h4>
