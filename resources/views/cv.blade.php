    ...
    <body>
        ...
        <div id="mySidenav" class="sidenav isMobile">
            ...
            <ul style="position:relative;">
                ...
                <li>
                    <a id="cvMenu" class="menuButton burgerMenuButtonWithImg selected" href="/cv" style="position:relative; right:3px;">
                        <img src="img\navBurgerImg\nav_cv_blue.png" class="navBurger_cvIcon" />
                        <span>Mon CV</span>
                    </a>
                </li>
                <li>
                        ...
                        <p class="pageSectionTitle">
                            ...
                            <svg class="trainingSvgContainer" style="position:absolute;">
                                <g class="formationSvg">
                                    ...
                                    />
                                    <path 
                                        class="formationSvgPath cvSvgPathBlue"
                        ...
                        <p class="pageSectionTitle">
                            ...
                            <svg class="hobbiesSvgContainer" style="position:absolute;">
                                <g class="hobbiesSvg">
                                    ...
                                    />
                                    <path 
                                        class="hobbiesSvgPath cvSvgPathBlue"
                        ...
                        <p class="pageSectionTitle pageSectionTitleMobile" style="text-align: center;">
                            ...
                            <svg class="skillsSvgContainer" style="position:absolute;">
                                <g class="skillsSvg">
                                    ...
                                    />
                                    <path 
                                        class="skillsSvgPath cvSvgPathBlue"
                        ...
                        <p class="pageSectionTitle outilsSectionTitleMobile">
                            ...
                            <svg class="outilsSvgContainer" style="position:absolute;">
                                <g class="outilsSvg">
                                    ...
                                    />
                                    <path 
                                        class="outilsSvgPath cvSvgPathBlue"
                        ...
                        <p class="pageSectionTitle">
                            ...
                            <svg class="langsSvgContainer" style="position:absolute;">
                                <g class="langsSvg">
                                    ...
                                    />
                                    <path 
                                        class="langsSvgPath cvSvgPathBlue"
